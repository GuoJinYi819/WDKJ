...
import com.wd.tech.adapter.gjyadapter.GroupFriendChildAdapter;

/**
 * ClassName: RecyclerViewDemo
 *
 * @author 作者 : GuoJinYi
 * @version 创建时间：2020/4/27 0027 11:01
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (item != null) {
                    //获取当前选中的Item
                    GroupFriendChildAdapter.MyChildHodler viewHolder = (GroupFriendChildAdapter.MyChildHodler) getChildViewHolder(item);
